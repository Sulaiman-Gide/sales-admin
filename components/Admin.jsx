    ...
    >
      ...
      <div className='flex flex-col w-full dark:bg-gray-900 h-[100svh] overflow-y-auto py-2 px-3 border-r-[1px] dark:border-gray-700'>
        ...
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-3'>
          <BiCategory size={20}  className='text-gray-600 dark:text-gray-50'/>
          <h1 className='text-gray-600 dark:text-gray-50 text-lg ml-3 font-semibold'>Category</h1>
        </div>
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-3'>
          <IoStatsChartOutline size={20}  className='text-gray-600 dark:text-gray-50'/>
          <h1 className='text-gray-600 dark:text-gray-50 text-lg ml-3 font-semibold'>Sales Report</h1>
        </div>
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-3'>
          <TbShoppingBagSearch size={20}  className='text-gray-600 dark:text-gray-50'/>
          <h1 className='text-gray-600 dark:text-gray-50 text-lg ml-3 font-semibold'>Products</h1>
        </div>
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-3'>
          <TbShoppingBagPlus size={20}  className='text-gray-600 dark:text-gray-50'/>
  ...
  return (
    <div className='w-full flex h-[100svh] overflow-y-hidden bg-gray-50 dark:bg-gray-900'>
      <div className='hidden sm:flex flex-col w-[230px] dark:bg-gray-900 h-[98vh] ml-2 my-auto rounded-md bg-white overflow-y-auto py-2 px-3 border-[1px] dark:border-gray-700'>
        ...
        <span className='border-b-[1px] border-gray-200 dark:border-gray-700 w-full p-2 my-2'></span>
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-4'>
          <BiCategory size={20}  className='text-gray-600 dark:text-gray-50'/>
          <h1 className='text-gray-600 dark:text-gray-50 text-lg ml-3 font-semibold'>Category</h1>
        </div>
        <div onClick={handletransactions} className='flex justify-start items-center w-full dark:border-none hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 cursor-pointer p-3 rounded-md mt-3'>
      ...
      <main className='w-full sm:w-5/6'>
        ...
        >
          <div className='flex justify-between items-center px-6 pt-4 pb-2'>
            ...
            <h2 className='text-xl sm:text-2xl'>Transactions</h2>
            <ThemeSwitcher className="dark:text-slate-50" />
          </div>
